...
<body>
<form action="employee/selEm" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">首页</a></li>
...
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		<li>
			<label>账号</label>
			<input name="account"  type="text" class="dfinput" placeholder="请输入账号" />
		</li>
	...
	<table class="imgtable"border = "5" >
		...
		<c:if test="${!empty adminList}">
			...
			<tr>
				...
				<td>${list.password}</td>
				<td>
					<a href = "employee/deleteEm?id=${list.id}" onclick="deleteUser()"><font color="blue">删除</font></a>
				</td>	
			</tr>
			</c:forEach>
		</c:if>
		...
		<div class="rightinfo">
			<div class="tools">
				<ul class="toolbar1">
					<li class="click"><span><img src="<%=basePath %>resource/admin/images/t01.png"/></span><a href="index/admin/employee/addEm.jsp">添加员工</a></li>
				</ul>
			</div>
		</div>
			<div class="pagin">
	<ul class="paginList">
	<a href="employee/selEm?page=1"><font>首页</font></a>&nbsp;&nbsp;
		共<i class="blue">&nbsp;${count}&nbsp;</i>条记录，共&nbsp;<i class="blue"> ${countPage}&nbsp;</i>页
		&nbsp;&nbsp;
	<a href="employee/selEm?page=${lastPage}">尾页</a>
	</ul>
</div>
</form>
