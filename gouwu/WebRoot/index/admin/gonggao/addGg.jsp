...
<form action = "shangpin/saveGg" method = "post"   class="validate" onsubmit="return add();" >
	<div class="formbody">
		<div class="formtitle"><span>添加新闻</span></div>
		<ul class="forminfo">
			<li>
				<label>标题</label>
				<input name="title" id="mname" type="text"  class="dfinput required" />&nbsp;&nbsp;
			</li>
			<li>
				<label>内容</label>
				<input name="content" id="mname" type="text"  class="dfinput required" />&nbsp;&nbsp;
			</li>
			<li>
				<label>&nbsp;</label>
