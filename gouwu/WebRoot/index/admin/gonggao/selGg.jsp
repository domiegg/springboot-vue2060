...
<body>
<form action="shangpin/selGg" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">首页</a></li>
	...
	<table class="imgtable"border = "5" >
		...
		<c:if test="${!empty lbList}">
			...
			<tr>
				...
				<td>${list.fname}</td>
				<td>
					<a href = "shangpin/showGg?id=${list.id}"><font color="blue">修改</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a href = "shangpin/deleteGg?id=${list.id}" onclick="deleteUser()"><font color="blue">删除</font></a>
				</td>	
			</tr>
			</c:forEach>
		</c:if>
		...
		<div class="rightinfo">
			<div class="tools">
				<ul class="toolbar1">
					<li class="click"><span><img src="<%=basePath %>resource/admin/images/t01.png"/></span><a href="index/admin/gonggao/addGg.jsp">添加新闻信息</a></li>
				</ul>
			</div>
		</div>
			<div class="pagin">
	<ul class="paginList">
	<a href="shangpin/selGg?page=1"><font>首页</font></a>&nbsp;&nbsp;
		共<i class="blue">&nbsp;${count}&nbsp;</i>条记录，共&nbsp;<i class="blue"> ${countPage}&nbsp;</i>页
		&nbsp;&nbsp;
	<a href="shangpin/selGg?page=${lastPage}">尾页</a>
	</ul>
</div>
</form>
