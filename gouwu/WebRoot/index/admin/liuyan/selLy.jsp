...
<body>
<form action="web/user/selLy" method="post" rel="page">
<div class="place">
	<span>位置：</span>
	<ul class="placeul">
		<li><a href="#">首页</a></li>
		<li><a href="#">查看留言信息</a></li>
	</ul>
</div>
<div class="formbody">
	...
	<ul class="forminfo" style="display: none;" id="forminfo">
		...
		<c:if test="${!empty lyList}">
			<c:forEach items="${lyList}" var="list" varStatus="vs">
			<tr>
				<td>${vs.index+1}</td>
				<td>${list.account}</td>
				<td>${list.title}</td>
				...
				<td>${list.date}</td>
				<td>
					<a href = "web/user/deleteLy?id=${list.id}"><font color="blue">删除</font></a>
				</td>	
			</tr>
			</c:forEach>
		</c:if>
	...
	<div class="pagin">
	<ul class="paginList">
	<a href="web/user/selLy?page=1"><font>首页</font></a>&nbsp;&nbsp;
		共<i class="blue">&nbsp;${count}&nbsp;</i>条记录，共&nbsp;<i class="blue"> ${countPage}&nbsp;</i>页
		&nbsp;&nbsp;
	<a href="web/user/selLy?page=${lastPage}">尾页</a>
	</ul>
</div>
</form>
