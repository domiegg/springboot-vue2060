...
<div id="xiugai">
	...
	<div class="content">
		...
		<div class="mid">
			...
			<form action="<%=basePath%>web/user/saveAdd" method="post">
				<label>姓名</label>
				<input class="aa" type="text" name="sname"  />
				<br />
				<label>电话</label>
				<input class="aa" type="text" name="stel"  />
				<br />
				<label>邮编</label>
				<input class="aa" type="text" name="youbian"   />
				<br />
				<label>送货地址</label>
